...
const HeroSection = () => {
  const handleOnClick = () => {
    window.open(
      "https://docs.google.com/forms/d/e/1FAIpQLSe3_A_ZFSFk-aZ5bHAdVn9TZ9F2asXdjFhaBf2uM6nC4hdXEw/viewform",
      "_blank",
      "noopener,noreferrer"
    );
  };
          ...
          >
            <div className="max-w-[550px] text-center hero_text">
              ...
              <p className="mt-4 text-base md:text-lg text-center leading-relaxed text-gray-300 font-medium font-montserrat">
                ISC empowers Ethiopian students to achieve their academic
                dreams, handling everything from documentation and visas to
                transportation and personalized support.
              </p>
              <Button
          ...
          >
            <div className="relative w-[530px] lg:w-[592px] h-[500px] flex-shrink-0 mx-auto md:mx-0 hero_image">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to bottom, rgba(1, 1, 58, 0) 50%, rgba(1, 1, 58, 0.8) 90%, #01013A 100%)",
                }}
              ></div>
