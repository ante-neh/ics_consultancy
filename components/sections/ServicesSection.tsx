      ...
      <Container className="max-w-[1300px]">
        <RevealWrapper origin="bottom" duration={2000} delay={200} >
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-montserrat font-bold text-[#01013A]">
                Our Services
              </h2>
              <p className="text-[#01013A] mt-4 text-center text-lg leading-relaxed font-montserrat font-normal">
