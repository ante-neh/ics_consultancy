      ...
      <Container className="text-white">
        <div className="container mx-auto px-6 py-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-start ">
          <div className="text-center md:text-left">
            <div className="flex flex-col items-center md:items-start mb-4">
              <h2 className="text-3xl font-bold text-[#00EDCF] mb-2 font-montserrat">
          ...
          {/* Section 2: Addresses */}
          <div className="text-center md:text-left">
            <h3 className="text-xl font-semibold mb-2 font-montserrat">Addresses:</h3>

            {/* Ethiopia */}
            <p className="font-montserrat">
              <strong className="font-montserrat font-light">Ethiopia:</strong> Addis Ababa, Bitweded Bahiru Building <br />
            ...
            <p className="mt-4 font-light font-montserrat">
              <strong className="font-light font-montserrat">Italy:</strong> Viale. 03043 Cassino, Province of Frosinone <br />
          ...
          <div className="text-center md:text-left">
            <h3 className="text-xl font-semibold mb-2 font-montserrat">Quick Links:</h3>
        ...
        <div className="border-t border-gray-600 mt-6">
          <div className="container mx-auto px-6 py-4 flex justify-center items-center text-sm ">
            <p className="mb-2 md:mb-0 font-montserrat">
